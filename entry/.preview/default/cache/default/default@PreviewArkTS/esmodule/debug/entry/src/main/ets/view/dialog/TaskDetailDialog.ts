...
function __Text__textStyle(): void {
    Text.fontColor({ "id": 16777351, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
...
export class TaskDetailDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/dialog/TaskDetailDialog.ets(42:5)");
            Column.height({ "id": 16777303, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Column.width({ "id": 16777297, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            ...
            Column.padding({
                bottom: { "id": 16777284, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" },
                left: { "id": 16777290, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" }
            });
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
...
class TaskBaseInfo extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/view/dialog/TaskDetailDialog.ets(78:5)");
            Column.position({ y: { "id": 16777295, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" } });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.taskName);
            Text.debugLine("entry/src/main/ets/view/dialog/TaskDetailDialog.ets(79:7)");
            Text.fontSize({ "id": 16777291, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            ...
            Text.margin({ left: { "id": 16777284, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" } });
        }, Text);
        Text.pop();
        Column.pop();
    }
...
class TaskClock extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/view/dialog/TaskDetailDialog.ets(99:5)");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithChild();
            Button.debugLine("entry/src/main/ets/view/dialog/TaskDetailDialog.ets(100:7)");
            Button.width({ "id": 16777292, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Button.borderRadius({ "id": 16777293, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777372, "type": 10003, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/view/dialog/TaskDetailDialog.ets(101:9)");
            Text.height({ "id": 16777301, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.fontSize({ "id": 16777290, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/dialog/TaskDetailDialog.ets(116:7)");
            Text.fontSize({ "id": 16777287, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
