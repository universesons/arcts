...
class TaskEdit extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/TaskEditPage.ets(23:5)");
            Row.height(Const.THOUSANDTH_1000);
            Row.backgroundColor({ "id": 16777385, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Navigation.create({ moduleName: "entry", pagePath: "entry/src/main/ets/pages/TaskEditPage" });
            Navigation.debugLine("entry/src/main/ets/pages/TaskEditPage.ets(24:7)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/TaskEditPage.ets(25:9)");
