...
export class AchievementIndex extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/view/AchievementComponent.ets(32:5)");
            Column.padding(Const.DEFAULT_10);
            Column.height(Const.FULL_HEIGHT);
            Column.width(Const.FULL_WIDTH);
            Column.backgroundColor({ "id": 16777328, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
