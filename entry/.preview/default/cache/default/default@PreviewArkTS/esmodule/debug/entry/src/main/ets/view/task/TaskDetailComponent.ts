...
export default class TaskDetail extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(103:5)");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(104:7)");
            Column.width(Const.THOUSANDTH_1000);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create({ space: Const.LIST_ITEM_SPACE });
            List.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(105:9)");
        ...
        }, List);
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(106:11)");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new TaskChooseItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 107 });
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(111:11)");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new TargetSetItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 112 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {};
                            };
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.padding({ left: Const.DEFAULT_12, right: Const.DEFAULT_12 });
                ListItem.enabled(this.settingParams?.isOpen);
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(125:11)");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new OpenRemindItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 126 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {};
                            };
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(131:11)");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new RemindTimeItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 132 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {};
                            };
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(140:11)");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new FrequencyItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 141 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {};
                            };
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(152:9)");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(153:11)");
            Text.fontSize({ "id": 16777290, "type": 10002, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Text.fontColor({ "id": 16777329, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
        }, Text);
        Text.pop();
        Button.pop();
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new TaskDialogView(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 166 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {};
                    };
