...
export default class TaskDetail extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(107:5)");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(108:7)");
            Column.width(Const.THOUSANDTH_1000);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create({ space: Const.LIST_ITEM_SPACE });
            List.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(109:9)");
        ...
        }, List);
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(110:11)");
            };
                ...
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            ...
                            // 任务开关
                            TaskChooseItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 112 });
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(116:11)");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new TargetSetItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 117 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {};
                            };
