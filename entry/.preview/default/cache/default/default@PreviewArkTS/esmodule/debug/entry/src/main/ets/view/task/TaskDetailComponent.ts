...
export default class TaskDetail extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(106:5)");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(107:7)");
            Column.width(Const.THOUSANDTH_1000);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            List.create({ space: Const.LIST_ITEM_SPACE });
            List.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(108:9)");
        ...
        }, List);
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(109:11)");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new TaskChooseItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 110 });
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(114:11)");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new TargetSetItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 115 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {};
                            };
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(129:11)");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new OpenRemindItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 130 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {};
                            };
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(135:11)");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new RemindTimeItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 136 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {};
                            };
        ...
        }
        {
            ...
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(144:11)");
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            let componentCall = new FrequencyItem(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 145 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {};
                            };
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(156:9)");
            Button.width(Const.THOUSANDTH_800);
            Button.height(Const.DEFAULT_48);
            Button.backgroundColor({ "id": 16777373, "type": 10001, params: [], "bundleName": "com.example.healthy_life", "moduleName": "entry" });
            Button.onClick(() => {
                this.finishTaskEdit();
            });
            Button.position({
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/task/TaskDetailComponent.ets(157:11)");
        ...
        Button.pop();
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new TaskDialogView(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/task/TaskDetailComponent.ets", line: 170 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {};
                    };
...
if (getPreviewComponentFlag()) {
    storePreviewComponents(1, "TaskDetail", new TaskDetail(undefined, {}));
    previewComponent();
}
else {
}
